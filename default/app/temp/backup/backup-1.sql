...
CREATE TABLE `ciudad` (
  ...
  `modificado_in` datetime DEFAULT NULL COMMENT 'Fecha de la 煤ltima modificaci贸n',
  PRIMARY KEY (`id`)
...
INSERT INTO `ciudad` VALUES (1,'Oca馻','2013-01-01 00:00:01',NULL);
...
CREATE TABLE `empresa` (
  ...
  `nit` varchar(15) NOT NULL COMMENT 'N煤mero de identificaci贸n tributaria de la empresa',
  `dv` int(2) DEFAULT NULL COMMENT 'Digito de verificaci贸n del NIT',
  `representante_legal` varchar(100) NOT NULL COMMENT 'Nombre del representante legal de la empresa',
  `nuip` bigint(20) NOT NULL COMMENT 'N煤mero de identificaci贸n personal',
  `tipo_nuip_id` int(1) NOT NULL COMMENT 'Tipo de identificaci贸n',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene la informaci贸n b谩sica de la empresa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empresa` VALUES (1,'Nombre de la Empresa','Empresa LTDA','1091652165',6,'Iv醤 David Mel閚dez',1091652165,1,'www.dailyscript.com.co','default.png','2013-01-01 00:00:01',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los men煤 para los usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `persona` (
  ...
  `nuip` bigint(20) NOT NULL COMMENT 'N煤mero de identificaci贸n personal',
  `tipo_nuip_id` int(11) NOT NULL COMMENT 'Tipo de identificaci贸n',
  `telefono` varchar(45) DEFAULT NULL,
  `fotografia` varchar(45) DEFAULT 'default.png' COMMENT 'Fotograf铆a',
  `registrado_at` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene las personas que interact煤an con el sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `persona` VALUES (1,'Error','Error',1010101010,1,NULL,'default.png','2013-01-01 00:00:01',NULL),(2,'Iv醤 David','Mel閚dez',1091652165,1,NULL,'default.png','2013-01-01 00:00:01',NULL);
...
INSERT INTO `recurso` VALUES (1,'*',NULL,NULL,'*','Comod韓 para la administraci髇 total (usar con cuidado)',1,'2013-01-01 00:00:01'),(2,'dashboard','*','*','dashboard/*/*','P醙ina principal del sistema',1,'2013-01-01 00:00:01'),(3,'sistema','mi_cuenta','*','sistema/mi_cuenta/*','Gesti髇 de la cuenta del usuario logueado',1,'2013-01-01 00:00:01'),(4,'sistema','acceso','*','sistema/acceso/*','Subm骴ulo para la gesti髇 de ingresos al sistema',1,'2013-01-01 00:00:01'),(5,'sistema','auditoria','*','sistema/auditoria/*','Subm骴ulo para el control de las acciones de los usuarios',1,'2013-01-01 00:00:01'),(6,'sistema','backup','*','sistema/backup/*','Subm骴ulo para la gesti髇 de las copias de seguridad',1,'2013-01-01 00:00:01'),(7,'sistema','mantenimiento','*','sistema/mantenimiento/*','Subm骴ulo para el mantenimiento de las tablas',1,'2013-01-01 00:00:01'),(8,'sistema','menu','*','sistema/menu/*','Subm骴ulo del sistema para la creaci髇 de men鷖',1,'2013-01-01 00:00:01'),(9,'sistema','perfil','*','sistema/perfil/*','Subm骴ulo del sistema para los perfiles de usuarios',1,'2013-01-01 00:00:01'),(10,'sistema','privilegio','*','sistema/privilegio/*','Subm骴ulo del sistema para asignar recursos a los perfiles',1,'2013-01-01 00:00:01'),(11,'sistema','recurso','*','sistema/recurso/*','Subm骴ulo del sistema para la gesti髇 de los recursos',1,'2013-01-01 00:00:01'),(12,'sistema','usuario','*','sistema/usuario/*','Subm骴ulo para la administraci髇 de los usuarios del sistema',1,'2013-01-01 00:00:01'),(13,'sistema','sucesos','*','sistema/suceso/*','Subm骴ulo para el listado de los logs del sistema',1,'2013-01-01 00:00:01'),(14,'sistema','configuracion','*','sistema/configuracion/*','Subm骴ulo para la configuraci髇 de la aplicaci髇 (.ini)',1,'2013-01-01 00:00:01'),(15,'config','empresa','*','config/empresa/*','Subm骴ulo para la configuraci髇 de la informaci髇 de la empresa',1,'2013-01-01 00:00:01'),(16,'config','sucursal','*','config/sucursal/*','Subm骴ulo para la administraci髇 de las sucursales',1,'2013-01-01 00:00:01');
...
CREATE TABLE `sucursal` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificaci贸n de la sucursal',
  ...
  `direccion` varchar(45) DEFAULT NULL COMMENT 'Direcci贸n de la sucursal',
  `telefono` varchar(45) DEFAULT NULL COMMENT 'N煤mero del tel茅fono',
  `fax` varchar(45) DEFAULT NULL COMMENT 'N煤mero del fax',
  `celular` varchar(45) DEFAULT NULL COMMENT 'N煤mero de celular',
...
INSERT INTO `sucursal` VALUES (1,1,'Oficina Principal','oficina-principal','Direcci髇','3162404183','3162404183','3162404183',1,'2013-01-01 00:00:01',NULL);
...
CREATE TABLE `tipo_nuip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_nuip` varchar(45) NOT NULL COMMENT 'Nombre del tipo de identificaci贸n',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Tabla que contiene los tipos de identificaci贸n de las personas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-01-22 20:24:04
